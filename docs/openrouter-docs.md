...
<Tip>
  Want to chat with our docs? Download an LLM-friendly text file of our [full documentation](https://openrouter.ai/docs) and include it in your system prompt.
</Tip>
...
* `Hyperbolic (quantized)`: [https://hyperbolic.xyz/terms](https://hyperbolic.xyz/terms)
...
![Alt text](file:cfe86a24-ee0b-4a71-a548-879203de46a9)
...
![Alt text](file:30e3ca30-fa46-42dd-b5f9-dd004567993e)
